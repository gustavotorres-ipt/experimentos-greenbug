...
def salvar_modelo( modelo_treinado: nn.Module, fold: int) -> None:
    ...
    pasta_resultados_espec = os.path.join(PASTA_RESULTADOS, f"{args.espectrograma}_{args.model}")
...
def salvar_metricas(
    ...
    caminho_json_final = f"{pasta_resultados_espec}/melhor_{nome_base}.json"
    ...
    ############
    caminho_json_evolucao = f"{pasta_resultados_espec}/evolucao_{nome_base}.json"
